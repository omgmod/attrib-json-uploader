...
docmarkers_json = FileUtils.read_json_file(f"{CLEAN_JSON_RELATIVE_PATH}/docmarkers.json")
...
warcp_data_service.insert_docmarkers(docmarkers_json, version_id)
...
print(f"Uploaded {len(docmarkers_json)} docmarkers stats records for version {version_id}")
